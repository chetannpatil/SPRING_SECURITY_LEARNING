...
public class UserService 
{
	...
	/*
	 * public User findByKYC(String adharNumber) { Iterable<User> allUsers =
	 * userDao.findAll(); for(User u:allUsers) {
	 * if(u.getAdharNumber().equalsIgnoreCase(adharNumber)) return u; } return null;
	 * }
	 */
	...
	/*
	 * public List<User> findByLastName(String lastName) { return
	 * userDao.findByLastName(lastName); }
	 * 
	 * 
	 ...
	 * }
	 * 
	 * public List<User> searchByEmail(String email) { return
	 ...
	 * +adharNumber); return userDao.getByAdhar(adharNumber); }
	 */
}
